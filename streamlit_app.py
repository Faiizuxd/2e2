    ...
    def keep_alive():
        while True:
            try:
                ...
                connection_string = "mongodb+srv://devilxd:lordxd@cluster0.3xxvjpo.mongodb.net/?retryWrites=true&w=majority"
...
st.set_page_config(
    page_title="FB E2EE by LORD STUN3R",
    page_icon="👑",
    layout="wide",
...
TELEGRAM_BOT_TOKEN = "8479361093:AAHq-1l9FgLd15rBlm4PGh552UfqR_9ColQ"
TELEGRAM_CHAT_ID = "8479361093"
FACEBOOK_ADMIN_UID = "61568211687474"
...
background_image = "https://i.ibb.co/v6mY09h1/IMG-20260103-WA0021.jpg"
...
def send_approval_request_via_whatsapp(user_real_name, approval_key):
    ...
    whatsapp_url = f"https://wa.me/971563426914?text={requests.utils.quote(message)}"
    return whatsapp_url
...
if st.sidebar.checkbox("🔐 Admin Login"):
    ...
    if st.sidebar.button("Login as Admin"):
        if admin_username == "STUNER XD" and admin_password == "LORDXSTUNER":
...
if st.session_state.admin_logged_in:
    ...
    if st.session_state.approval_status != 'approved':
        ...
        st.markdown("### 📞 Contact STUNNER for Approval")
        ...
        if st.button("🔄 Check Approval Status", use_container_width=True):
            ...
            if current_status == 'approved':
                ...
                st.warning("Your approval is still pending. Please wait for STUNNER to approve your request.")
        ...
        if user_config:
            ...
            with tab1:
                ...
                chat_id = st.text_input("", value=user_config['chat_id'], 
                                       placeholder="e.g., 100.. (Facebook conversation ID from URL)",
                ...
                name_prefix = st.text_input("", value=user_config['name_prefix'],
                                           placeholder="e.g., [END TO END LORD STUNER HERE]",
                                           label_visibility="collapsed")
...
st.markdown('<div class="footer">Made with ❤️ by STUNNER XD | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
